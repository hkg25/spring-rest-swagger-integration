...
import poc.modal.CustomerList;
import poc.modal.ErrorInfo;
import poc.service.CustomerService;
...
public class CustomerServiceController {
	...
	@RequestMapping(method = RequestMethod.GET, produces = { MediaType.APPLICATION_JSON_VALUE }, value = "customer/{id}")
	@ResponseBody
	...
	@RequestMapping(method = RequestMethod.GET, produces = { MediaType.APPLICATION_JSON_VALUE }, value = "customers")
	@ResponseBody
	...
	@RequestMapping(method = RequestMethod.POST, consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = { MediaType.APPLICATION_JSON_VALUE }, value = "customer/create")
	...
	@RequestMapping(method = RequestMethod.DELETE, produces = { MediaType.APPLICATION_JSON_VALUE }, value = "customer/delete/{id}")
	...
	@RequestMapping(method = RequestMethod.PUT, consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = { MediaType.APPLICATION_JSON_VALUE }, value = "customer/update/{id}")
	public @ResponseBody Customer updateCustomer(
			@PathVariable("id") Integer id, @RequestBody Customer customer) {
	...
	@RequestMapping(method = RequestMethod.PATCH, consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = { MediaType.APPLICATION_JSON_VALUE }, value = "customer/partial/update/{id}")
	public @ResponseBody Customer updatePartialCustomer(
			@PathVariable("id") Integer id, @RequestBody Customer customer) {
	...
	public ErrorInfo handleTypeMismatchException(HttpServletRequest req,
		...
		String errorMessage = messageSource.getMessage("error.customer.id",
				new Object[] { ex.getValue() }, locale);
